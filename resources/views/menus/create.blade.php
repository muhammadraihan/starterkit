        ...
        <div id="panel-1" class="panel">
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    {!! Form::open(['route' => 'menus.store','method' => 'POST','class' =>
                    'needs-validation','novalidate']) !!}
                    <div class="form-row">
                        <div class="form-group col-md-4 mb-3">
                            {!! Form::label('menu_title', 'Menu Title', ['class' => 'required form-label']) !!}
                            {!! Form::text('menu_title', null, ['placeholder' => 'Menu Title','class' => 'form-control
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-2 mb-3">
                            ...
                            {!! Form::text('order', null, ['placeholder' => 'Order Position','class' => 'form-control
                        ...
                        <div class="form-group col-md-2 mb-3">
                            ...
                            {!! Form::text('icon_class', null, ['placeholder' => 'Icon Class','class' =>
                            'form-control
                        ...
                        <div id="parent-div" class="form-group col-md-4 mb-3" style="display:none">
