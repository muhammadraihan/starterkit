...
<div class="row">
    <div class="col-xl-6">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
            <h2>Edit <span class="fw-300"><i>Slide</i></span></h2>
                <div class="panel-toolbar">
                    <a class="nav-link active" href="{{route('slide.index')}}"><i class="fal fa-arrow-alt-left">
                        </i>
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    @endif
                    {!! Form::open(['route' => ['slide.update',$slide->uuid],'method' => 'PUT','class' =>
                    'needs-validation','novalidate', 'enctype' => 'multipart/form-data']) !!}
                    <div class="form-group col-md-4 mb-3">
                        {{ Form::label('photo','Photo',['class' => 'required form-label'])}}
                        <input type="hidden" name="oldImage" value="{{ $slide->photo }}"> 
                        @if ($slide->photo)
                            <img src="{{ asset('photo/' . $slide->photo) }}" class="img-preview img-fluid mb-3 col-sm-5 d-block">
                        @else
